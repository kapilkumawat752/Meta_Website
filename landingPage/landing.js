...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        // Perform an AJAX request to submit the form data to Salesforce
        // Replace 'YOUR_SALESFORCE_ENDPOINT' with your actual Salesforce Web-to-Lead endpoint
        fetch('https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8', {
            ...
            .then(response => {
                if (response.ok) {
                    // The form was submitted successfully, show the success message
